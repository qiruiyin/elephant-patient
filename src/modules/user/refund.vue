...
<template>
    ...
    <div class="refund-content">
    	<x-textarea v-model="content" :height="160" placeholder="这一刻的想法..." :max="maxNum"></x-textarea>
...
<script type="text/babel">
  ...
  import elPriviewerImg from 'components/priviewer-img'
      ...
      removeImg (ind) {
        ...
        formData.append('file', blob);
          ...
          headers:{'Content-Type':'multipart/form-data'}
				...
				this.$http.post('/wechat/refundsmobile/addrefunds',
						formData,
						config
					).then(function(e) {
						if(e.data.errcode == 1) {
        ...
        if(!_this.content) {
          ...
          return false
				...
				this.$http.post('/wechat/refundsmobile/save',
						{
